...
public class PaymentRequestAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 248401518762088947L;
   ...
   */
  public PaymentRequestAvroModel(java.util.UUID id, java.util.UUID memberId, java.util.UUID orderId, java.math.BigDecimal price, java.time.Instant createdAt, PaymentOrderStatus paymentOrderStatus) {
    this.id = id;
  ...
  public Object get(int field$) {
    ...
    case 5: return paymentOrderStatus;
  ...
  public void put(int field$, Object value$) {
    ...
    case 1: memberId = (java.util.UUID)value$; break;
    ...
    case 5: paymentOrderStatus = (PaymentOrderStatus)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentRequestAvroModel>
    ...
    private Builder(PaymentRequestAvroModel.Builder other) {
      ...
      if (isValidValue(fields()[5], other.paymentOrderStatus)) {
        this.paymentOrderStatus = data().deepCopy(fields()[5].schema(), other.paymentOrderStatus);
    ...
    /**
      ...
      * @return This builder.
      */
    public PaymentRequestAvroModel.Builder setMemberId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public PaymentRequestAvroModel.Builder clearMemberId() {
      memberId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public PaymentRequestAvroModel.Builder setOrderId(java.util.UUID value) {
    ...
    public PaymentRequestAvroModel build() {
      try {
        ...
        record.memberId = fieldSetFlags()[1] ? this.memberId : (java.util.UUID) defaultValue(fields()[1]);
        ...
        record.paymentOrderStatus = fieldSetFlags()[5] ? this.paymentOrderStatus : (PaymentOrderStatus) defaultValue(fields()[5]);
        return record;
