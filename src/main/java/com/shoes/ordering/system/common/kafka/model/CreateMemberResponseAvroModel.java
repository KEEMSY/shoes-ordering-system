...
public class CreateMemberResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageEncoder<CreateMemberResponseAvroModel> ENCODER =
      new BinaryMessageEncoder<>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<CreateMemberResponseAvroModel> DECODER =
   ...
   */
  public static BinaryMessageEncoder<CreateMemberResponseAvroModel> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<CreateMemberResponseAvroModel> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<CreateMemberResponseAvroModel> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this CreateMemberResponseAvroModel to a ByteBuffer.
  ...
  /**
   * Deserializes a CreateMemberResponseAvroModel from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a CreateMemberResponseAvroModel instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static CreateMemberResponseAvroModel fromByteBuffer(
   ...
   */
  public CreateMemberResponseAvroModel() {}
   ...
   */
  public CreateMemberResponseAvroModel(java.util.UUID memberId, MemberStatus memberStatus, java.util.List<java.lang.String> message, java.time.Instant createdAt) {
  ...
  /**
   * Creates a new CreateMemberResponseAvroModel RecordBuilder.
   * @return A new CreateMemberResponseAvroModel RecordBuilder
   */
  public static CreateMemberResponseAvroModel.Builder newBuilder() {
    return new CreateMemberResponseAvroModel.Builder();
  }

  /**
   * Creates a new CreateMemberResponseAvroModel RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new CreateMemberResponseAvroModel RecordBuilder
   */
  public static CreateMemberResponseAvroModel.Builder newBuilder(CreateMemberResponseAvroModel.Builder other) {
    if (other == null) {
      return new CreateMemberResponseAvroModel.Builder();
    } else {
      return new CreateMemberResponseAvroModel.Builder(other);
    }
  }

  /**
   * Creates a new CreateMemberResponseAvroModel RecordBuilder by copying an existing CreateMemberResponseAvroModel instance.
   * @param other The existing instance to copy.
   * @return A new CreateMemberResponseAvroModel RecordBuilder
   */
  public static CreateMemberResponseAvroModel.Builder newBuilder(CreateMemberResponseAvroModel other) {
    if (other == null) {
      return new CreateMemberResponseAvroModel.Builder();
    } else {
      return new CreateMemberResponseAvroModel.Builder(other);
  ...
  /**
   * RecordBuilder for CreateMemberResponseAvroModel instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CreateMemberResponseAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(CreateMemberResponseAvroModel.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing CreateMemberResponseAvroModel instance
     * @param other The existing instance to copy.
     */
    private Builder(CreateMemberResponseAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.memberId)) {
        this.memberId = data().deepCopy(fields()[0].schema(), other.memberId);
    ...
    /**
      ...
      * @return This builder.
      */
    public CreateMemberResponseAvroModel.Builder clearMemberId() {
      memberId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public CreateMemberResponseAvroModel.Builder setMemberStatus(MemberStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public CreateMemberResponseAvroModel.Builder clearMemberStatus() {
      memberStatus = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public CreateMemberResponseAvroModel.Builder clearMessage() {
      message = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public CreateMemberResponseAvroModel.Builder setCreatedAt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public CreateMemberResponseAvroModel.Builder clearCreatedAt() {
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<CreateMemberResponseAvroModel>
    WRITER$ = (org.apache.avro.io.DatumWriter<CreateMemberResponseAvroModel>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<CreateMemberResponseAvroModel>
    READER$ = (org.apache.avro.io.DatumReader<CreateMemberResponseAvroModel>)MODEL$.createDatumReader(SCHEMA$);
