...
public class UpdateMemberRequestAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageEncoder<UpdateMemberRequestAvroModel> ENCODER =
      new BinaryMessageEncoder<>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<UpdateMemberRequestAvroModel> DECODER =
   ...
   */
  public static BinaryMessageEncoder<UpdateMemberRequestAvroModel> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<UpdateMemberRequestAvroModel> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<UpdateMemberRequestAvroModel> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this UpdateMemberRequestAvroModel to a ByteBuffer.
  ...
  /**
   * Deserializes a UpdateMemberRequestAvroModel from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a UpdateMemberRequestAvroModel instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static UpdateMemberRequestAvroModel fromByteBuffer(
   ...
   */
  public UpdateMemberRequestAvroModel() {}
   ...
   */
  public UpdateMemberRequestAvroModel(java.lang.String memberId, java.lang.String name, java.lang.String password, java.lang.String email, MemberKind memberKind, MemberStatus memberStatus, java.lang.String phoneNumber, StreetAddress address, java.time.Instant createdAt) {
  ...
  /**
   * Creates a new UpdateMemberRequestAvroModel RecordBuilder.
   * @return A new UpdateMemberRequestAvroModel RecordBuilder
   */
  public static UpdateMemberRequestAvroModel.Builder newBuilder() {
    return new UpdateMemberRequestAvroModel.Builder();
  }

  /**
   * Creates a new UpdateMemberRequestAvroModel RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new UpdateMemberRequestAvroModel RecordBuilder
   */
  public static UpdateMemberRequestAvroModel.Builder newBuilder(UpdateMemberRequestAvroModel.Builder other) {
    if (other == null) {
      return new UpdateMemberRequestAvroModel.Builder();
    } else {
      return new UpdateMemberRequestAvroModel.Builder(other);
    }
  }

  /**
   * Creates a new UpdateMemberRequestAvroModel RecordBuilder by copying an existing UpdateMemberRequestAvroModel instance.
   * @param other The existing instance to copy.
   * @return A new UpdateMemberRequestAvroModel RecordBuilder
   */
  public static UpdateMemberRequestAvroModel.Builder newBuilder(UpdateMemberRequestAvroModel other) {
    if (other == null) {
      return new UpdateMemberRequestAvroModel.Builder();
    } else {
      return new UpdateMemberRequestAvroModel.Builder(other);
  ...
  /**
   * RecordBuilder for UpdateMemberRequestAvroModel instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UpdateMemberRequestAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(UpdateMemberRequestAvroModel.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing UpdateMemberRequestAvroModel instance
     * @param other The existing instance to copy.
     */
    private Builder(UpdateMemberRequestAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.memberId)) {
        this.memberId = data().deepCopy(fields()[0].schema(), other.memberId);
    ...
    /**
      ...
      * @return This builder.
      */
    public UpdateMemberRequestAvroModel.Builder setMemberId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public UpdateMemberRequestAvroModel.Builder clearMemberId() {
      memberId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public UpdateMemberRequestAvroModel.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public UpdateMemberRequestAvroModel.Builder clearPassword() {
      password = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public UpdateMemberRequestAvroModel.Builder clearEmail() {
      email = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public UpdateMemberRequestAvroModel.Builder setMemberKind(MemberKind value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public UpdateMemberRequestAvroModel.Builder clearMemberKind() {
      memberKind = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public UpdateMemberRequestAvroModel.Builder setMemberStatus(MemberStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public UpdateMemberRequestAvroModel.Builder clearMemberStatus() {
      memberStatus = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public UpdateMemberRequestAvroModel.Builder clearPhoneNumber() {
      phoneNumber = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public UpdateMemberRequestAvroModel.Builder clearAddress() {
      address = null;
      addressBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public UpdateMemberRequestAvroModel.Builder setCreatedAt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public UpdateMemberRequestAvroModel.Builder clearCreatedAt() {
    ...
    public UpdateMemberRequestAvroModel build() {
      try {
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<UpdateMemberRequestAvroModel>
    WRITER$ = (org.apache.avro.io.DatumWriter<UpdateMemberRequestAvroModel>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<UpdateMemberRequestAvroModel>
    READER$ = (org.apache.avro.io.DatumReader<UpdateMemberRequestAvroModel>)MODEL$.createDatumReader(SCHEMA$);
