...
public class UpdateProductResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public UpdateProductResponseAvroModel(java.util.UUID productId, String name, ProductCategory productCategory, String description, java.math.BigDecimal price, java.time.Instant createdAt) {
