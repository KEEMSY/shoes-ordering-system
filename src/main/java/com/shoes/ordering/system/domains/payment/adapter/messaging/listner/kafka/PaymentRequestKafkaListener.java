...
import com.shoes.ordering.system.domains.payment.adapter.messaging.mapper.PaymentMessagingDataMapper;
...
public class PaymentRequestKafkaListener implements KafkaConsumer<PaymentRequestAvroModel> {
    ...
    @Override
    @KafkaListener(id = "${kafka-consumer-config.payment-consumer-payment-group-id}",
